...
C<[>, C<[[>, L<C<arp>|/"arp">, L<C<ash>|/"ash">, L<C<awk>|/"awk">, L<C<bash>|/"bash">, L<C<blkid>|/"blkid">, L<C<cat>|/"cat">, L<C<chgrp>|/"chgrp">, L<C<chmod>|/"chmod">, L<C<chown>|/"chown">, L<C<clear>|/"clear">,
L<C<comm>|/"comm">, L<C<cp>|/"cp">, L<C<crc32>|/"crc32">, L<C<cttyhack>|/"cttyhack">, L<C<cut>|/"cut">, L<C<date>|/"date">, L<C<dd>|/"dd">, L<C<df>|/"df">, L<C<dmesg>|/"dmesg">, L<C<dos2unix>|/"dos2unix">, L<C<du>|/"du">,
L<C<echo>|/"echo">, L<C<env>|/"env">, C<false>, L<C<fdisk>|/"fdisk">, L<C<find>|/"find">, L<C<free>|/"free">, L<C<ftpget>|/"ftpget">, L<C<getfattr>|/"getfattr">, L<C<grep>|/"grep">, L<C<halt>|/"halt">,
L<C<hdparm>|/"hdparm">, L<C<head>|/"head">, L<C<hexedit>|/"hexedit">, L<C<hostname>|/"hostname">, L<C<httpd>|/"httpd">, L<C<ifconfig>|/"ifconfig">, L<C<init>|/"init">, L<C<ip>|/"ip">, L<C<ipaddr>|/"ipaddr">,
L<C<iplink>|/"iplink">, L<C<iproute>|/"iproute">, L<C<kill>|/"kill">, L<C<less>|/"less">, L<C<ln>|/"ln">, L<C<losetup>|/"losetup">, L<C<ls>|/"ls">, L<C<lsblk>|/"lsblk">, L<C<makedevs>|/"makedevs">,
L<C<mkdir>|/"mkdir">, L<C<mkdosfs>|/"mkdosfs">, L<C<mkfifo>|/"mkfifo">, L<C<mkfs.vfat>|/"mkfs.vfat">, L<C<mknod>|/"mknod">, L<C<mkswap>|/"mkswap">, L<C<mktemp>|/"mktemp">, L<C<mount>|/"mount">, L<C<mv>|/"mv">,
L<C<nc>|/"nc">, L<C<netcat>|/"netcat">, L<C<nice>|/"nice">, L<C<nohup>|/"nohup">, L<C<partprobe>|/"partprobe">, L<C<pidof>|/"pidof">, L<C<ping>|/"ping">, L<C<pivot_root>|/"pivot_root">,
L<C<poweroff>|/"poweroff">, L<C<printf>|/"printf">, L<C<ps>|/"ps">, L<C<pstree>|/"pstree">, L<C<pwd>|/"pwd">, L<C<readlink>|/"readlink">, L<C<realpath>|/"realpath">, L<C<reboot>|/"reboot">,
L<C<reset>|/"reset">, L<C<rm>|/"rm">, L<C<rmdir>|/"rmdir">, L<C<route>|/"route">, L<C<sed>|/"sed">, L<C<seedrng>|/"seedrng">, L<C<seq>|/"seq">, L<C<sh>|/"sh">, L<C<sha384sum>|/"sha384sum">, L<C<sleep>|/"sleep">,
L<C<sort>|/"sort">, L<C<ssl_server>|/"ssl_server">, L<C<stat>|/"stat">, L<C<stty>|/"stty">, L<C<sync>|/"sync">, L<C<tail>|/"tail">, L<C<tee>|/"tee">, L<C<telnet>|/"telnet">, C<test>,
L<C<timeout>|/"timeout">, L<C<top>|/"top">, L<C<touch>|/"touch">, L<C<tr>|/"tr">, C<tree>, L<C<tsort>|/"tsort">, L<C<udhcpc>|/"udhcpc">, L<C<uevent>|/"uevent">, L<C<umount>|/"umount">, L<C<uname>|/"uname">,
L<C<unix2dos>|/"unix2dos">, L<C<uuidgen>|/"uuidgen">, L<C<vi>|/"vi">, L<C<vmstat>|/"vmstat">, L<C<watch>|/"watch">, L<C<wc>|/"wc">, L<C<wget>|/"wget">
...
wget [-cqS] [-O FILE] [-o LOGFILE] [-Y on/off] [-P DIR] [-U AGENT] [-T SEC] URL...
